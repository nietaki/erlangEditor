...
%% API
-export([insert_char/3, delete_char/2, split/2, is_a_change/1, cursor_position/1, apply_change/2, apply_changes_verbose/2, apply_changes/2]).
...
cursor_position({delete_char, Pos}) -> Pos;
cursor_position({insert_char, Pos, _Char}) -> Pos + 1.
